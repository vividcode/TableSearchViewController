...
let SECTION_HEADER_CHECKBOX_OFFSET = 50.0
let SECTION_HEADER_HEIGHT = 50.0
let SECTION_HEADER_LABEL_HEIGHT = 30.0
let CHECKBOX_HEIGHT = 30.0
let CHECKBOX_WIDTH = 30.0
let DEFAULT_SECTION_HEADER_HEIGHT = 50.0
let DEFAULT_SECTION_FOOTER_HEIGHT = 50.0
